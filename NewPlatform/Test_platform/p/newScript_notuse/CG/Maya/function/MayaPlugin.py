...
class MayaPlugin(object):
    
    def __init__(self, log=None):
        
        self.log = log
        #self.pluginsInfoXml = r'\\10.50.1.22\td\plugins\maya\mayaPlugins.xml'
        #self.pluginsInfoXml = r'C:\Users\sanchan\workspace\mayaApp\src\MayaPluginLoad\mayaPlugins.xml'
    ...
    def MayaPlugin(self, *args):
        ...
        if self.plginInfoFromXML:
            self.setcg_name([self.plginInfoFromXML['cg_name'], self.plginInfoFromXML['cg_version']])
            # soft_name = self.plginInfoFromXML['cg_name']
            # soft_ver = self.plginInfoFromXML['cg_version']
            # print "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
            # print soft_name
            # print soft_ver
            print "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++="
            if "gpuid" in os.environ:
                ...
                self.do_clear_render_pre([self.plginInfoFromXML['cg_name'], self.plginInfoFromXML['cg_version']])
            ...
            if self.plginInfoFromXML.has_key('plugins'):
                ...
                print plugin_list
                self.do_auto_load_plu(self.plginInfoFromXML['cg_version'],plugin_list)
    ...
    def doGetClientInfo(self, *args):
        ...
        try:
            ...
            '''
            #for test
            self.plginInfoFromXML = {'cg_name':'maya', \
                               'cg_version':'2012', \
    ...
    def setcg_name(self, *args):
        
        inputSW = args[0][0]
        inputVer = args[0][1]
        inputSW = inputSW.lower()
    ...
    def doParseXml(self):
        ...
        if self.renderSW and self.swVer:
            ...
            print "+77777777777777777777777777"  + version
            ...
            self.print_log('Please execute "setcg_name" first!')
            self.errReturn = 1
...
class clientRenderInfo():
    ...
    def rdrSW(self, *args):
        if self.plginInfo.has_key('cg_name'):
            return self.plginInfo['cg_name']
        else:
            return None
    
    def swVer(self, *args):
        if self.plginInfo.has_key('cg_version'):
            return self.plginInfo['cg_version']
        else:
            return None
...
if __name__ == '__main__':
    ...
    # 1. run setcg_name with the input software and version
    ...
    plginsLd = MayaPlugin()
    rtn = plginsLd.MayaPlugin('C:\Users\sanchan\workspace\mayaApp\src\mayaConfig\plugins.cfg', [])
    print 'rtn', rtn
    ...
    if len(sys.argv) > 1:
        ...
        if plginsLd.plginInfoFromXML:
            plginsLd.setcg_name([plginsLd.plginInfoFromXML['cg_name'], plginsLd.plginInfoFromXML['cg_version']])
