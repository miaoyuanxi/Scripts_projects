...
#-----------------------Render----------------------------------------
class LQRenderAction():
	def __init__(self,**paramDict):
		cgName=paramDict['G_CG_NAME']
		print 'cgName=================='+cgName
		exec('LQRenderAction.__bases__=('+cgName+',)')
		exec(cgName+'.__init__(self,**paramDict)')

	def RBrender(self):#7
		self.G_RENDER_LOG.info('[LQ_Maya.RBrender.start.....]')
		self.G_RENDER_LOG.info('[hello world]')
		...
		self.G_RENDER_LOG.info('[LQ_Maya.RBrender.end.....]')
...
if(__name__=="__main__"):
	...
	render=LQRenderAction(**paramDict)
