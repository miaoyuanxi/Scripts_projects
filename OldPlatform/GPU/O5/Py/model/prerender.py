...
if user_id in [1917342,1835213,1881622,1859026,1863099,1883450,1877965,1879546,1833958]:
...
if user_id in [1844817,961743,1844765,963567,1860992,962371,1854466,1811755,1863576,1878285,1877869,1864856,1876209,1876088,1903427,1912043]:
    print "set Redshift VRAM"
    for i in pm.ls(type='RedshiftOptions'):
        if i.hasAttr("maxNumGPUMBForIrradiancePointCloudHierarchy"):
            print "Irradiance Point Cloud is 512"
