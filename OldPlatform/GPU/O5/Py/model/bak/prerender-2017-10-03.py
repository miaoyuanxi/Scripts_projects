...
print "test_GPU_prerender_999999999999999999999"
def rd_path():
...
if user_id in [964309]:
    print "  "
    rd_path()
    if taskid in [16002447]
    
    
        cmds.setAttr("redshiftOptions.maxNumGPUMBForForICPHierarchy",256)  
        cmds.setAttr("redshiftOptions.percentageOfGPUMemoryToUse",95)  
        cmds.setAttr("redshiftOptions.numGPUMBToReserveForRays",4096)  
        cmds.setAttr("redshiftOptions.maxNumCPUMBForTextureCache",8192)  
