...
#                os.system(r'"xcopy /y /v /e \\10.50.5.29\o5\py\model\maya2017\prefs\pluginPrefs.mel C:\users\enfuzion\Documents\maya\2017\prefs\ "')
        ...
        if not self["common"]["plugin_file"]:
            ...
            if self["common"]["userId"] in [1879130]:
                print("preRender...")
                cmd += " -preRender \"python execfile(\\\\\\\"//10.90.100.101/o5/py/model/pre.py\\\\\\\")\\\"\\"
            ...
            if self["common"]["userId"] in [962276]:
                ...
                cmd = "\"%s\" && %s" % (pre_bat, cmd)
        if self["common"]["userId"] in [1881622,1861699,1853812,1844577,1859047,963567,1867173,1878285]:
        ...
        if "RenderMan_for_Maya" in self["plugins"]["plugins"]:
            ...
            if self["common"]["userId"] in [1873149,1886200,1868563,1813649,1859026,961743,1833038,964311,1819610,1814856,1848484,1848680,963567,1820265,964309,1864685,1860992,119768,962371,1821671,1854466,1811755,1863576,1863884,1863099,1877869,1864856,1883450,1877965,1846192,1876209]:  
                ...
                #cmd +=" -preRender \"python \\\"execfile(\\\\\\\"//10.60.100.101/o5/py/model/961743.py\\\\\\\")\\\"\" -r redshift -logLevel 1"
                #cmd += " -preRender \"python \\\"user_id=%s;mapping=%s;plugins=%s;taskid=%s;execfile(\\\\\\\"//10.70.242.102/o5/py/model/prerender.py\\\\\\\")\\\"\" -r redshift -logLevel 1 " % (self["common"]["userId"],self["mappings"],self["plugins"]["plugins"],self["common"]["taskId"])
                    cmd += " -preRender \"python \\\"user_id=%s;mapping=%s;plugins=%s;taskid=%s;rendersetting=%s;start=%s;end=%s;execfile(\\\\\\\"//10.90.100.101/o5/py/model/prerender.py\\\\\\\")\\\"\" -r redshift -logLevel 1 " % (self["common"]["userId"],self["mappings"],self["plugins"]["plugins"],self["common"]["taskId"],self["renderSettings"],self["renderSettings"]["start"],self["renderSettings"]["end"])
                else :
                    cmd += " -r redshift -logLevel 1"
            elif self["common"]["taskId"] in [16112288]:
                cmd += " -r redshift -logLevel 1"
            else:
                cmd += " -r redshift -logLevel 1"
            ...
            # if self["common"]["userId"] in [1868563]:
                # print "dan ka gpu"
                # gpu_n="0"
            if self["common"]["taskId"] in [16113973,16113974,16113981,16113982,16113983,16113984,16113999,16114095]:
                print "dan ka gpu"
                gpu_n="0"
        ...
        if self["common"]["userId"] in [1844817,1873149]:
        ...
        if "-r rman" in cmd:
            ...
            if self["common"]["taskId"] in [16060988]:
                cmd += " -x 10 -y 10 \"%(maya_file)s\"" % self["renderSettings"]
