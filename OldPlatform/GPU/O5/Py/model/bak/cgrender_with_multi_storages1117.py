...
#        return subprocess.call(command, shell=1)
    ...
    def clean_network(self):
        if self["server"]["user_id"] in [1807088]:
            return 0
...
class MayaRender(MayaClass):
    ...
    #                    cmd += " -im \"%s\"" % image_name
        ...
        if self["server"]["user_id"] in [1820390,964647,1812927,1811737,1811222,1301816,963433,963685,1816635,1801684,1819610,963260]:
