    ...
    def render_vray
        begin
            ...
            if $total_frame==1
                ...
                outputLog("outputfile:"+""+$output_directory+$output_name + "#{$format}" +"")
                VRayForSketchUp.setOutputPath(""+$output_directory+$output_name + "#{$format}" +"")
                ...
                outputLog(""+"set do_animation:false"+"")
                VRayForSketchUp.set_option_value("/SettingsOutput", "do_animation", "bool", false)
                outputLog("outputfile:"+""+$output_directory+$output_name + $currentframe.to_s + "#{$format}" +"")
                VRayForSketchUp.setOutputPath(""+$output_directory+$output_name + $currentframe.to_s + "#{$format}" +"")
                VRayForSketchUp.setOutputSize($width, $height)
                VRayForSketchUp.launch_vray_render 
            end
