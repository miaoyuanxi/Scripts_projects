...
:cgrender_with_multi_storages
    ...
    echo "c:\python27\python.exe" "%py_path%\cgrender_with_multi_storages.py" --ti %taskId% --sf %startframe% --ef %endframe% --by %byframe% --pt %pt% --sp %proj% --tile_index %tile_index% --tiles %tiles%
    "c:\python27\python.exe" "%py_path%\cgrender_with_multi_storages.py" --ti %taskId% --sf %startframe% --ef %endframe% --by %byframe% --pt %pt% --sp %proj% --tile_index %tile_index% --tiles %tiles%
goto end
