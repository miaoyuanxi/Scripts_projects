...
:cgrender_with_multi_storages
	...
	echo "c:\python27\python.exe" "\\10.50.5.29\o5\py\model\cgrender_with_multi_storages.py" --ti %taskId% --sf %startframe% --ef %endframe% --by %byframe% --pt 1005 --sp %proj% --tile_index %tile_index% --tiles %tiles%
	"c:\python27\python.exe" "\\10.50.5.29\o5\py\model\cgrender_with_multi_storages.py" --ti %taskId% --sf %startframe% --ef %endframe% --by %byframe% --pt 1005 --sp %proj% --tile_index %tile_index% --tiles %tiles%
goto end
