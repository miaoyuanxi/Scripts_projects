...
:default
	...
	xcopy /y /f "\\10.70.242.102\o5\py\model\maya2017\prefs\pluginPrefs.mel" "C:\users\enfuzion\Documents\maya\2017\prefs\"
    xcopy /y /f "\\10.70.242.102\o5\py\model\maya2016.5\prefs\pluginPrefs.mel" "C:\users\enfuzion\Documents\maya\2016.5\prefs\"
	echo "c:\python27\python.exe" "\\10.70.242.102\o5\py\model\cgrender.py" --js %json% --pl %plugins_json% --sf %startframe% --ef %endframe% --by %byframe% --pt 1008
	"c:\python27\python.exe" "\\10.70.242.102\o5\py\model\cgrender.py" --js %json% --pl %plugins_json% --sf %startframe% --ef %endframe% --by %byframe% --pt 1008
goto end
