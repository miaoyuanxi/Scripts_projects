...
G_CONFIG=r'\\10.90.100.101\p5\config\100000\100001\16000820\render.json'
G_PLUGINS=r'\\10.90.100.101\p5\config\100000\100001\16000820\plugins.json'
G_RENDEROS=r''
...
##name=100001_16000820_render.py
##requirements=BCGPU
##properties=BCGPU
##level=79
##custom=100001
