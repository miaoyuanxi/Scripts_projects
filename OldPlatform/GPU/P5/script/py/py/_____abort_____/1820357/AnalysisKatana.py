...
class Katana(AnalysisBase):
	def __init__(self,**paramDict):
		...
		self.analysePyPath="c:/script/katana"
		self.analyseScriptPath="c:/script/katana"
	...
	def RBanalyse(self):#7
		...
		analysePyPath=os.path.join(self.analysePyPath,self.analyse_py_name)
		analyseScriptPath=os.path.join(self.analyseScriptPath,self.script_name)
