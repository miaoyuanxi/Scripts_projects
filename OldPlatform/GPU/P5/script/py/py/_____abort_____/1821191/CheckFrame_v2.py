...
class CheckFrame():
    ...
    def checkFrames(self,pathin1 = '',pathin2 = '',checkturn=1):
        ...
        if return_final==judgment_times:
            self.LOG.info("Final chech result: 0")
            return 0
        else:
...
checkObj=CheckFrame()
print("\nFinal check result: ",checkObj.checkFrames(path_local,path_server,1))
print("\nFinal warning result: ",checkObj.checkFrames(path_local,path_server,1))
'''
###---------------------------------------------------------------------------------------------------###
