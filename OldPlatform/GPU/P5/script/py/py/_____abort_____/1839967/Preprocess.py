...
class Preprocess(RenderBase):
    ...
    def RBrender(self):
        ...
        if  os.path.exists(netRenderTxt):
            ...
            maxZip=os.path.join(self.G_HELPER_TASK_MAX,os.path.basename(cgFile))
            if maxZip.endswith('.7z') and os.path.exists(maxZip):
    ...
    def readRenderCfg(self):
        ...
        if self.RENDER_CFG_PARSER.has_option('common','skipUpload'):
            self.SKIP_UPLOAD=self.RENDER_CFG_PARSER.get('common','skipUpload')
