...
#           os.system('xcopy /y /v /f  "\\\\10.50.1.3\\p\\script\\py\\cleanNode.py" "c:/script/py/"')
    ...
    def RBresultAction(self):
        ...
        if self.G_RENDEROS=='Linux':
            ...
            feemnt='mount -t cifs -o username=administrator,password=Ruiyun@2012,codepage=936,iocharset=gb2312 '+self.G_PATH_COST.replace('\\','/').replace("/mnt","//10.50.244.116")+' '+feePath
