...
class RenderbusPath():
    def __init__(self,userPath,assetCollectAbsolutePath):
        ...
        self.ASSET_COOLECT_ABSOLUTE_PATH=assetCollectAbsolutePath
    ...
    def convertPath(self,itemPath):
        if self.ASSET_COOLECT_ABSOLUTE_PATH:
            absPath=[['a:/','/a/'],
                ['b:/','/b/'],
                ['c:/','/c/'],
                ['d:/','/d/']]
...
class Max(AnalysisBase):
    def __init__(self,**paramDict):
        ...
        self.ASSET_COOLECT_ABSOLUTE_PATH=False
        ...
        self.assetInputDict     = {}
        self.renderbusPathObj   = RenderbusPath(self.G_INPUT_USER,self.ASSET_COOLECT_ABSOLUTE_PATH)
        self.checkIflItems      = []
    ...
    def getIflList(self,iflFile,resultList):
        ...
        if self.ASSET_COOLECT_ABSOLUTE_PATH:
            ...
            iflBaseName=os.path.basename(iflFile)
            if iflBaseName in assetInputList:
                reallyIflFile=self.ASSET_INPUT_DIR_DICT[iflBaseName]
        
        print 'reallyIflFile----',reallyIflFile
        if os.path.exists(reallyIflFile): 
            #print '[exists]'
    ...
    def loopInputAsset(self):
        if not self.ASSET_COOLECT_ABSOLUTE_PATH:
