...
class NodeHelper:
    ...
    def cleanFolder(self):
        self.cleanFolderByStayTime('d:/work/helper',72)
        self.cleanFolderByStayTime('d:/work/render',72)
        self.cleanFolderByStayTime('d:/log/helper',72)
        self.cleanFolderByStayTime('d:/log/render',72)
