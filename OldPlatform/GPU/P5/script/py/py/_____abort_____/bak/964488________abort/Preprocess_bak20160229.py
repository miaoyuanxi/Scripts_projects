    ...
    def CopyFile(self):
        ...
        if self.RENDER_CFG_PARSER.has_section('texture'):
            for textureKey in textureKeyList:
                print type(self.RENDER_CFG_PARSER.get('texture',textureKey))
            ...
            for files in fileList:
                ...
                if os.path.exists(filePath):
                    ...
                    if isinstance(cmd,unicode):
                        ...
                        print 'ggggggg'
                        cmd.decode('gbk').encode('utf-16')
                    '''
                    
                    #self.RBcmd(ur''.join(cmd))
                    #self.RBcmd(cmd.decode("utf-8").encode("s_jisx0213"))
                    #self.RBcmd(cmd.encode('utf-8'))
                    #self.RBcmd(r'D:\work\render\560576\cfg\fcopy.bat')
