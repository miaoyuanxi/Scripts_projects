...
class RenderBase():
    ...
    '''
    def copyBlack(self):
        cmd="xcopy /y /f \"B:\\tools\\sweeper\\black.xml\" \"c:\\work\\munu_client\\sweeper\\\""
        self.RBcmd(cmd)
    ...
    def RBinitLog(self):#2
        ...
        #renderLogHandler=logging.FileHandler(renderLogPath,encoding="UTF-8")
