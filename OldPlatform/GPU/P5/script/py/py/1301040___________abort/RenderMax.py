...
class MaxClient(RenderBase):
    ...
    def substPath(self):
        ...
        batStr=batStr+'net use B: '+self.argsmap['pluginPath'].replace('/','\\').replace("10.60.100.151","10.60.100.152")+' \r\n'
    ...
    def writeMsFile2(self,msFile,sceneFile,renderOutput,renderFrame,notRender):
        ...
        if self.argsmap.has_key('from') and self.argsmap['from']=='web':
            ...
            webArrayStr=webArrayStr+self.G_JOB_NAME+'","'+renderOutput+'/","'+self.G_PLATFORM+'","'+myCamera+'","'+self.CURRENT_TASK+'","web","'+sceneFile+'") \r\n'
            ...
            clientArrayStr=clientArrayStr+self.G_JOB_NAME+'","'+renderOutput+'/","'+self.G_PLATFORM+'","'+myCamera+'","'+self.CURRENT_TASK+'","client")\r\n'
