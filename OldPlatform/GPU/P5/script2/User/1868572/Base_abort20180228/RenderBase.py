...
#           os.system('xcopy /y /v /f  "\\\\10.50.1.3\\p\\script\\py\\cleanNode.py" "c:/script/py/"')
    ...
    def RBnodeClean(self):
        ...
        if self.G_RENDEROS == 'Windows':
            ...
            f1 = r'D:\Temp\REDSHIFT\CACHE\Redshift\Cache\Textures'
            f2 = r'D:\Temp\REDSHIFT\CACHE\G0\Redshift\Cache\Textures'
            f3 = r'D:\Temp\REDSHIFT\CACHE\G1\Redshift\Cache\Textures'

            NC4 = NodeCleaner(log_path, 7 * 24, self.G_PROCESS_LOG)
            NC4.clean_texture_cache_dir(f1)
            NC4.clean_texture_cache_dir(f2)
            NC4.clean_texture_cache_dir(f3)
            """ceui rfyr id 1868572"""
