...
class C4Dparser():
    ...
    #(4, '\xe5\x8f\xb0\xe9\x98\xb62.mov')
    #(8, 'F:\\1lywork\\201707\\\xe6\x9d\xad\xe5\xb7\x9e\xe4\xbf\xa1\xe8\xbe\xbe\\UV\\\xe4\xb9\xb1\xe9\x97\xaa\\\xe5\xa4\xa9\xe5\xb9\x95\\light_1.mov')
    ...
    def extract_texture(self, items):
        for item in items:
            ...
            texture = os.path.normpath(texture).decode('string_escape')
