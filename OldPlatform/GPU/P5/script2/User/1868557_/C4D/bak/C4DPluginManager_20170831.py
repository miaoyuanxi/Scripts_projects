...
class C4DPluginManagerCenter(object):
    ...
    def set_custom_env(self, plugin):
        ...
        elif plugin_name == 'gsg_hdri_studio_pack':
        ...
        elif plugin_name == 'octane_GPU':
            myname, myaddr = self.__check_gpu()
            if myname.startswith('GPU'):
                #拷贝之前先删除节点机下的MAXON和OctaneRender文件夹
                print '-----------start remove MAXON and OctaneRender-----------'
                ...
                #remove C:\Program Files\MAXON\CINEMA 4D R18\plugins\c4doctane
                print '-----------start remove RXX\plugins\c4doctane-----------'
                ...
                #copy bak file
                print '----------start copy MAXON and OctaneRender------------'
...
if __name__ == "__main__":
    ...
    plugin2.soft_version     = "CINEMA 4D R16"
    plugin2.node             = "ABCDEF"
