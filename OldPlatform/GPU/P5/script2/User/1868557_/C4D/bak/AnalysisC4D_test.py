...
class C4D(AnalysisBase):
    ...
    def copyPyp(self):
        ...
        source="\\\\10.60.100.101\\p5\\script2\\User\\1868557\\C4D\\a0000\\Analys.pyp"
        ...
        if os.path.exists(self.G_PLUGINS):
            ...
            if isinstance(configJson["plugins"],dict):
                ...
                for key in configJson["plugins"]:
                    cmd = '\\\\10.60.100.101\\p5\\script2\\User\\1868557\\C4D\\a0000\\plugin.bat "'+myCgVersion+'" "'+key+'" "'+configJson["plugins"][key]+'" "'+node+'"'
        ...
        if os.path.exists(self.G_PLUGINS):
            ...
            if isinstance(configJson["plugins"], dict):
                ...
                for key in configJson["plugins"]:
                    ...
                    self.G_ANALYSE_LOG.info('[ python = C:\\Python27\\python.exe "\\\\10.60.100.101\\p5\\script2\\User\\1868557\\C4D\\C4DPluginManager.py" "%s" "%s" "%s" "%s" ]' % (plugin.plugin_name, \
    ...
    def RBanalyse(self):#7
        ...
        c4dbat='\\\\10.60.100.101\\p5\\script2\\User\\1868557\\C4D\\a0000\\C4D.bat'
        #14.0.361
