...
#           os.system('xcopy /y /v /f  "\\\\10.50.1.3\\p\\script\\py\\cleanNode.py" "c:/script/py/"')
    ...
    def RBnodeClean(self):
        ...
        NC1=NodeCleaner(self.G_LOG_WORK,30*24,self.G_PROCESS_LOG)
        NC1.main()
        
        NC2=NodeCleaner(self.G_RENDER_WORK,7*24,self.G_PROCESS_LOG)
        NC2.main()
        
        NC3=NodeCleaner(self.G_HELPER_WORK,7*24,self.G_PROCESS_LOG)
        NC3.main()
        
        # if self.G_RENDEROS == 'Windows':
            # temp_folder = r'D:\Temp\REDSHIFT'
            # NC4=NodeCleaner(temp_folder,0,self.G_PROCESS_LOG)
            # NC4.main()
