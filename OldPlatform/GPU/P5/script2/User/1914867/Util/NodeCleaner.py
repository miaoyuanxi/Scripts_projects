...
class NodeCleaner(object):
    ...
    def del_log(self):
        ...
        del_log_handler = logging.FileHandler(del_log_path, encoding='utf-8')
    ...
    def clean_texture_cache_dirs(self, texture_dirs):
        try:
        ...
        for folder in texture_dirs:
            self.clean_texture_cache_dir(folder)
    ...
    def main(self):
        ...
        try:
            ...
            self.log_print('[warn]del %s fail' % self.G_CLEAN_FOLDER)
