...
#           os.system('xcopy /y /v /f  "\\\\10.50.1.3\\p\\script\\py\\cleanNode.py" "c:/script/py/"')
    ...
    def RBnodeClean(self):
        ...
        else:  # self.G_RENDEROS == 'Linux'
            log_path = r'/tmp/nzs-data/redshift_cache'
            texture_dirs = [
                r'/tmp/nzs-data/redshift_cache'
            ]
        
        NC4 = NodeCleaner(log_path, redshift_stay_hours, self.G_PROCESS_LOG)
