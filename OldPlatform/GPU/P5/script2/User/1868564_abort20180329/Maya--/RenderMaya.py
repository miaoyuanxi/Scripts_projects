...
class Maya(RenderBase):
    ...
    def RBrender(self):#7
        ...
        #os.system(renderCmd)
        self.RBcmd_test20180329(renderCmd,False,1,myLog=True)
        self.RBcmd_test20180329(renderCmd2,False,myLog=True)
    ...
    def RBcmd_test20180329(self,cmdStr,continueOnErr=False,myShell=False,myLog=False):
        ...
        while True:
            ...
            if resultLine:
                ...
                if 'Render progress end' in resultLine:
                    break
            else:
                break
