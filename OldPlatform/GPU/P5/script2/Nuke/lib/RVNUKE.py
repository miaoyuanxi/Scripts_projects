...
def getFrameList(frameIn, frameOut, interval, fileName, multiRenderNum = 2):
    video_list = ["mov", "mp4"]
...
def createCMDList(nukeExecutePath, renderThreads, write, nkPath, _SFM, _EFM, _BFM, fileName, multiRenderNum = 2):



    frameList = getFrameList(_SFM, _EFM, _BFM, fileName, multiRenderNum = 2)
    cmdList = []
...
def _RV_renderWrite(write,_NK, _SFM,_EFM,_BFM,_IN,_OUT,_CGV,_CID):
    print '---------------------------------------'
    print 'write = ', write
...
###############################################################################
    ...
    cmdList = createCMDList(nukeExecutePath, max_threads_number, write, _NK, _SFM, _EFM, _BFM, fileName, multiRenderNum = 2)
