    ...
    def set_custom_env(self, plugin):
        ...
        if plugin.plugin_name == 'c4dtoa':
            ...
            if myname.startswith('GPU'):
                if plugin.plugin_version == '3.06.0':
                ...
                if plugin.plugin_version == '3.07.0' or '3.07.0_R2':
                    ...
                    time.sleep(15)
                    print '[002----------APPDATA-MAXON AND OCTANE FCOPY------------]'
                    os.system(r'start C:/fcopy/FastCopy.exe /force_close /cmd=sync "B:\plugins\C4D\octane_GPU\octane_GPU_3.07.0\CINEMA 4D R18\appdata\MAXON" /to="%appdata%\MAXON"')
                    os.system(r'start C:/fcopy/FastCopy.exe /force_close /cmd=sync "B:\plugins\C4D\octane_GPU\octane_GPU_3.07.0\CINEMA 4D R18\appdata\OctaneRender" /to="%appdata%\OctaneRender"')
                    time.sleep(15)
                    os.system(r'start C:/fcopy/FastCopy.exe /force_close /cmd=sync "B:\plugins\C4D\octane_GPU\octane_GPU_3.07.0\CINEMA 4D R19\appdata\MAXON" /to="%appdata%\MAXON"')
                    os.system(r'start C:/fcopy/FastCopy.exe /force_close /cmd=sync "B:\plugins\C4D\octane_GPU\octane_GPU_3.07.0\CINEMA 4D R19\appdata\OctaneRender" /to="%appdata%\OctaneRender"')
            else:
                return False
        else:
            pass
