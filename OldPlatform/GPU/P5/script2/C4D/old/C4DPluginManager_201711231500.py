...
class C4DPluginManagerCenter(object):
    ...
    def get_dll(self,soft_version):
        ...
        os.system('copy "%s" "%s" ' % (dll_src, soft_src))
    ...
    def set_custom_env(self, plugin):
        ...
        if plugin.plugin_name == 'c4dtoa':
            ...
            os.system('copy "%s" "%s" ' % (ai_path, c4d_installed_path))
            os.system('copy "%s" "%s" ' % (lic_path, c4d_installed_path))
            ...
            os.system('copy "%s" "%s" ' % (HDRI_Studio, HDRI_C4DPlugin))
            ...
            os.system('copy "%s" "%s" ' % (Rollit_path, Rollit_C4DPlugin))
            ...
            os.system('copy "%s" "%s" ' % (unfolder_path, unfolder_path))
            ...
            print (r'start C:/fcopy/FastCopy.exe /force_close "' + codevonc_depliage_path + '\\" /to="' + codevonc_depliage_C4DPlugin + '"')
            os.system (r'start C:/fcopy/FastCopy.exe /force_close "' + codevonc_depliage_path + '\\" /to="' + codevonc_depliage_C4DPlugin + '"')
            print 'cv_vrcam...HL...plugin already done!!'
            ...
            print (r'start C:/fcopy/FastCopy.exe /force_close "' + codevonc_depliage_path + '\\" /to="' + codevonc_depliage_C4DPlugin + '"')
            os.system (r'start C:/fcopy/FastCopy.exe /force_close "' + codevonc_depliage_path + '\\" /to="' + codevonc_depliage_C4DPlugin + '"')
            print 'transform...HL...plugin already done!!'
            ...
            os.system('copy "%s" "%s" ' % (TopCoat_PC_path, TopCoat_PC_appdata))
            ...
            os.system('copy "%s" "%s" ' % (vray_key_path, vray_key_dest_path))
            ...
            os.system('copy "%s" "%s" ' % (rd_lic_src, rd_lic_dest))
            ...
            if myname.startswith('GPU'):
                ...
                os.system('copy "%s" "%s" ' % (octane_src_path, octane_dest_path))
                print '-----------copy done---------------'
