...
class Lightwave(RenderBase):
    ...
    def RBrender(self):#7
        ...
        mayaExePath=os.path.join('B:/NewTek/',"LightWave_"+self.G_CG_VERSION,'bin/lwsn.exe')
        ...
        renderBat= os.path.join('B:/plugins/LightWave/script/LightWave.bat')
        ...
        renderCmd=renderBat +' "'+self.G_USERID+'"  "'+self.G_TASKID+'"  "'+mayaExePath+'" "'+renderTxtFile+'" "'+self.G_CG_START_FRAME+'" "' + self.G_CG_END_FRAME +'" "'+self.G_CG_BY_FRAME +'" "'+ self.G_PATH_INPUTPROJECT +'" "'+ self.G_PATH_INPUTFILE+'" "'+ self.G_CONFIG+'" "'+ self.G_PLUGINS+'" '+ ' >>' + '"' + outputrenderlogFile +'"'
