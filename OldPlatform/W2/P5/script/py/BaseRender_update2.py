...
class Max(Base):
	...
	def RBrender(self):#7
		...
		if hasattr(self,'G_FRAMES_JOB'):
			if self.G_FRAMES_JOB=='1':
				...
				myframe=self.G_CG_START_FRAME+'_'+self.G_CG_END_FRAME+'_'+self.G_CG_BY_FRAME
				renderCmd='c:/script/max/'+self.G_RENDERBAT_NAME+' "'+self.G_CG_VERSION+'" "'+self.G_CG_RENDER_VERSION+'" ' + self.G_USERID+' '+self.G_TASKID + ' 0 ' +myframe +' '+self.G_KG+' "'+self.G_JOB_NAME+'" "' +cgFile+'"'
				self.RBcmd(renderCmd,True,False)			
		else:
			renderCmd='c:/script/max/'+self.G_RENDERBAT_NAME+' "'+self.G_CG_VERSION+'" "'+self.G_CG_RENDER_VERSION+'" ' + self.G_USERID+' '+self.G_TASKID + ' 0 ' +self.G_CG_START_FRAME  +' '+self.G_KG+' "'+self.G_JOB_NAME+'" "' +cgFile+'"'
			self.RBcmd(renderCmd,True,False)
