...
class Preprocess(RenderBase):
    ...
    def __init__(self,**paramDict):
        ...
        self.G_RENDER_TASK_MAX2=os.path.join(self.G_RENDER_TASK,'max2')
                        ...
                        if file1.endswith('.max') or file1.endswith('.max.7z'):
                            ...
                            if os.path.exists(filePath):
                                ...
                                if file1.endswith('.max.7z'):
                                    ...
                                    moveToMaxBakCmd='c:\\fcopy\\FastCopy.exe /cmd=move /speed=full /force_close  /no_confirm_stop /force_start "'+file1.replace('/','\\')+'" /to="'+self.G_HELPER_TASK_MAXBAK.replace('/','\\')+'"'
    ...
    def runMax(self):
        if self.MAX_PREPROCESS:
            ...
            print preCmd
            DogUtil.maxCmd(preCmd,self.G_PROCESS_LOG)
    ...
    def PackFile2(self):
        ...
        if self.MAX_PREPROCESS:
            packMaxFolder=self.G_RENDER_TASK_MAX2
