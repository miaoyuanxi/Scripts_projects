...
class Maya(RenderBase):
	...
	def copyBlack(self):
		...
		blackPath="\\\\10.60.100.102\\td\\tools\\sweeper\\black.xml"
		if self.G_RENDEROS=='Linux':
	...
	def RBrender(self):#7
		...
		customConfigCmd ='"c:\\python27\\python.exe"'+' "\\\\10.60.100.102\\td\\custom_config\\1833691\\RayvisionCustomConfig.py"'
		self.RBcmd(customConfigCmd,False,1)
