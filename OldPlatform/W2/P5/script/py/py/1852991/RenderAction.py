...
class RenderAction():
	def __init__(self,**paramDict):
		...
		print 'cgName=================='+cgName
		exec('RenderAction.__bases__=('+cgName+',)')  #RenderAction.__bases__=(MaxClient,):Change the base class of RenderAction to MaxClient in RenderMax
		exec(cgName+'.__init__(self,**paramDict)')  #MaxClient.__init__(self,**paramDict)
	'''
