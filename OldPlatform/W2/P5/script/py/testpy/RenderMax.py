...
class MaxClient(RenderBase):
    ...
    def RBrender(self):#7
        ...
        if self.G_KG=='100' and self.argsmap.has_key('currentTask') and self.argsmap['currentTask'] in 'photon' and self.argsmap.has_key('giframes'):
            renderFrame=self.argsmap['giframes']
