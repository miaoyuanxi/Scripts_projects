...
:Render_Configure_164684
	set _bat_null=null
	set _bat_file=%_bat_file:164684//=164684/%
	...
	"%RENDER_ROOT%/hbatch.exe" -e _configroots=%global_root% -e _isrendering=1 -e _cmd_cid=%_bat_cid% -e _cmd_tid=%_bat_tid% -e _cmd_sf=%_bat_sf% -e _cmd_ef=%_bat_ef% -e _cmd_bf=%_bat_bf% -e _cmd_rd=%_bat_rd% -e _cmd_hip=%_bat_file% -e _cmd_ext=%_bat_ext% -e _cmd_rop=%_bat_rop% -e _cmd_opt=%_bat_opt% "//10.50.8.2/p/td/liyuguang/houdini_s/_NC_houdini_start_164684.cmd"
	goto end
