...
:default
	...
	echo "c:\python27\python.exe" "%py_path%\cgrender.pyc" --js %json% --pl %plugins_json% --sf %startframe% --ef %endframe% --by %byframe% --pt %pt%
	"c:\python27\python.exe" "%py_path%\cgrender.pyc" --js %json% --pl %plugins_json% --sf %startframe% --ef %endframe% --by %byframe% --pt %pt%
goto end
