...
set cg_file=%5
set cg_info_file=%~6
REM if %task_id:~0,2%==10 (set py_path=\\10.60.100.105\stg_data\input\o5\py\model&&set pt=1000&&set b_path=\\10.60.100.151\td)
if %task_id:~0,1%==9 (set py_path=\\10.60.100.101\o5\py\model&&set pt=1002&&set b_path=\\10.60.100.151\td)
if %task_id:~0,2%==10 (set py_path=\\10.60.100.101\o5\py\model&&set pt=1002&&set b_path=\\10.60.100.151\td)
...
:LightWave
    set cmd="C:\Python27\python.exe" "%py_path%\check_all_test.py" --cgfile %cg_file% --cg_info_file "%cg_info_file%" --cgsw LightWave --ti %task_id%
    echo Run: %cmd%
    %cmd%
    goto End
