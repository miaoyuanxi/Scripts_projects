...
def _RV_App_Hou_Setup(_SERVER_IP_ROOT, vers, skip_flag):
    print "_RV_App_Hou_Setup running, _SERVER_IP_ROOT:%s, vers:%s, skip_flag:%s" % (_SERVER_IP_ROOT, vers, str(skip_flag))
    ...
    if not os.path.exists(todir):
        ...
        #rebult.main(todir)
        # os.rmdir(todir)
        # print("Do a removed of houdini folder")
        os.makedirs(todir)
    # print("makes folders for houdini")
