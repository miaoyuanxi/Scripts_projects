...
class C4DPluginManagerCenter(object):
    ...
    def set_custom_env(self, plugin):
        ...
        # including: c4dtoa, gsg_hdri_studio_pack,trypogen,realflow,rollit,unfolder,reeper,codevonc_depliage,
        #            Light_kit_infinite_free,cv_vrcam,meshboolean,transform,topcoat_pc,vray,redshift_GPU,octane_GPU
...
'''
#test:
# "C4DPluginManager.py" "CINEMA 4D R17" "c4dtoa" "2.0.2" "ABCDEF"
