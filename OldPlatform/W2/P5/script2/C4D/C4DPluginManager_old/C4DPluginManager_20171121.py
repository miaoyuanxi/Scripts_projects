...
class C4DPluginManagerCenter(object):
    ...
    def set_custom_env(self, plugin):
        ...
        if plugin.plugin_name == 'c4dtoa':
            ...
            #os.system('echo f | xcopy /f /y /e "%s" "%s"' % (reeper_path, reeper_C4DPlugin))
        ...
        elif plugin.plugin_name == 'C4DU13':
            print 'C4DU13'
            C4DU13_path = plugin_c4d_path + r"\\*.*"
            print C4DU13_path  + '===C4DU13===='
            C4DU13_C4DPlugin = os.path.join(r"C:/Program Files/MAXON", \
                                        self.plugin.soft_version)
            print C4DU13_C4DPlugin + '...C4DU13...'
            os.system(r'start C:/fcopy/FastCopy.exe /force_close /cmd=sync "B:\plugins\C4D\C4DU13\C4DU13_1.3\CINEMA 4D R18\plugins\C4DU13\" /to="C:\Program Files\MAXON\CINEMA 4D R18\plugins\C4DU13"')
