...
class Katana(RenderBase):
	...
	def outputMnt(self):
		...
		outputmnt='mount -t cifs -o username=enfuzion,password=ruiyun2016,codepage=936,iocharset=gb2312 '+self.G_PATH_USER_OUTPUT.replace(self.outputFolder,'').replace('\\','/')+' '+self.outputPath
