...
G_CONFIG=r'\\10.60.100.101\p5\temp\10444793_render\cfg\photon.cfg'
G_PLUGINS=r''
G_RENDEROS=r''
baseRenderPy=r'\\10.60.100.101\p5\script\py\py\common'
userRenderPy=r'\\10.60.100.101\p5\script\py\py\1918940'
G_VRAY_LICENSE='1'
#script_param_mark#
...
##name=1918940_10444793_render.py
##requirements=|OS-Windows|RAM-128
##properties=||PICTURE
##category=PICTURE
##level=50
##customer=1918940
