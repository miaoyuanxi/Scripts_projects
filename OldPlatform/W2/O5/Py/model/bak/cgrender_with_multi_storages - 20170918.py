...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if "RenderMan_for_Maya" in self["plugins"]["plugins"]:
            ...
            gpu_n="0,1"
            cmd += " -gpu {%s}" % (gpu_n)
        elif self["common"]["userId"] in [1860501,962413,962640,1814964,963287, 963492,1861648]:
