...
class MayaPlugin(PluginBase):
        ...
        if allPlugDict and 'plugins' in allPlugDict:
            ...
            if pluginDict:
                for pluginName in pluginDict:  
                    ...
                    if pluginName in  ['redshift','alshader','Cryptomatte','Domemaster3D']:                        
                    ...
                    if os.path.exists(pluginConfigFile):
                        ...
                        if not os.path.exists(pluginZipSource) and os.path.exists(pluginZipSource_pro) and os.path.exists(pluginZipSource_clientM): 
                            index += 1
    ...
    def config_plugin(self, *args):
        ...
        if self.pluginPost:
            self.do_load_plugins_cfg(self.pluginPost,validInfoPost)
