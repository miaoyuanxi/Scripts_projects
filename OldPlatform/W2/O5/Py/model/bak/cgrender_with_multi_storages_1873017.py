...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if self["common"]["userId"] in [1866675,1872761,1855708,900045,963452,1869176,964590,1803147,1868555,1858235,1865216,963568,1858637,1812345,1862096,119768,963250,1816742,1833038,1844854,1017637,1843698,1832764,1833080,1833047,1833042,1847323,1300061,1814856,1818411,1840793,1848725,1815272,963260,1852550,1843088,1852657,1016752,830123,1818014,1805679,1861025,1844068,1843589,1855835,1814431,1859072,1859047,1813119,1860909,962276,1860293,1849290,1861648,1841452,1807271,1861569,1863971,1863854,1855110,1834849,1862390,1857988,1860992,1163411,1845209,1837976,1865164,1845216,1822281,1852326,1840038,1868563,1870188,1861572,1849653,1867734]:
        ...
        if self["common"]["userId"] in [1818415]:
            # cmd += " -preRender \"python \\\"execfile(\\\\\\\"//10.60.100.101/o5/py/model/1818415.py\\\\\\\")\\\"\""
            cmd += " -preRender \"source \\\"//10.60.100.101/o5/py/model/1818415.mel\\\"\" "
        ...
        elif self["common"]["userId"] in [1870881,1868555,1844854,1860501,962640,1814964,963287, 963492,1861648]:
        ...
        if self["common"]["userId"] in [1863884,1843663,962814,1852174,1871138]:
        ...
        if self["common"]["userId"] in [1812148,1830380,1871175]:    
            cmd += " -preRender \"python \\\"user_id=%s;mapping=%s;plugins=%s;taskid=%s;rendersetting=%s;execfile(\\\\\\\"//10.60.100.101/o5/py/model/1812148.py\\\\\\\")\\\"\"" % (self["common"]["userId"],self["mappings"],self["plugins"]["plugins"],self["common"]["taskId"],self["renderSettings"])
