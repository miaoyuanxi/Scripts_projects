...
class MayaRender(MayaClass):
    ...
    #                    cmd += " -im \"%s\"" % image_name
        ...
        print self["mappings"]
        if self["common"]["userId"] in [1861877,1017637,1844577,1820999,1857698,1853469,1843589,1861628,1805997,1862416,1849290,1863429,1840132,1863854,1833038,1826800,1862577]:
