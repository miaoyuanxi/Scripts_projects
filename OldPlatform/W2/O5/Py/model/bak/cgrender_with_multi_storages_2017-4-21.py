    ...
    def render(self):
        ...
        if not self["common"]["plugin_file"]:
            ...
            if self["common"]["userId"] in [962276]:
                ...
                cmd = "\"%s\" && %s" % (pre_bat, cmd)
        if self["common"]["userId"] in [1017637] and "vrayformaya" in self["plugins"]["plugins"]:
            cmd += " -r vray -threads 0 "
        if self["common"]["userId"] in [1017637,1843698,1832764,1833080,1833047,1833042,1847323]:
        ...
        if "RenderMan_for_Maya" in self["plugins"]["plugins"]:
            ...
            if self["common"]["userId"] in [961743,1844765,964311,1819610]:
