...
class ArnoldClass(Render):
    ...
    def set_plugins(self):
        ...
        if os.path.exists(custom_file):
            ...
            plugin_info = {"kick.exe": "//10.50.1.22/td/plugins/maya/mtoa/maya2013/mtoa_1.2.2.0/maya_mtoa/bin/kick.exe",
                           "args": {"-l": "//10.50.1.22/td/plugins/maya/mtoa/maya2013/mtoa_1.2.2.0/maya_mtoa/shaders",
                                    "-g": 2.2,
                                    "-v": 2,
                                    "-t": 0
                                    }
...
class MayaRender(MayaClass):
    ...
    #                    cmd += " -im \"%s\"" % image_name
        ...
        if self["common"]["userId"] in [1833083,1841730,963287, 963492, 963250, 964462,965366]:
        ...
        #           % self["renderSettings"]
        if self["common"]["userId"] in [1841730]:
            cmd += " -preRender \"python \\\"import cam_switch;cam_switch.main()\\\" \"';'\"python \\\"rendersetting=%s;execfile(\\\\\\\"%s/pre_render_1841730.py\\\\\\\")\\\"\"" % (self["renderSettings"], self["common"]['pre_render'])
