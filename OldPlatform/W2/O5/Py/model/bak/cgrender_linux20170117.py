...
class MayaClass(Render):
    ...
    def get_maya_info(self):
        ...
        if self.is_linux:
            ...
            self["renderSettings"]["output"] = "/root/rayvision/work/render/%s/output/" % \
                (self["common"]["taskId"])
...
class MayaRender(MayaClass):
    ...
    #                    cmd += " -im \"%s\"" % image_name
        ...
        if self["common"]["userId"] in [1813121,963287, 963492, 963250, 964462,965366]:
            cmd += " -r arnold -ai:lve 1 -ai:ltc 1"
