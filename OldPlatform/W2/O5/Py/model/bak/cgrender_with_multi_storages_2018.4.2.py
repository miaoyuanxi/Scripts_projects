...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if self["common"]["userId"] in [1872633]:
            ...
            adict = self["mappings"]
            adict["T"]="/prod/cgserver-02/"
            print adict
            self["mappings"] = adict
            
            
            
        if self["common"]["userId"] not in [1844854,1875231,1846887,1854355,1814593,963931,1873017,1812148,1812148,1830380,1871175,1803147] and HQID:
