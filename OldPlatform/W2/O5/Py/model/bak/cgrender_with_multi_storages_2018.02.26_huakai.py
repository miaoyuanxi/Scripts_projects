...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if self["common"]["userId"] in [962814,1849749,1858642,1858237,1858240,1858241, 1858637, 1858638,1879929]:
        ...
        if self["common"]["userId"] not in [1844854,1875231,1846887,1854355,1814593,963931,1873017,1812148,1812148,1830380,1871175,1873851] and HQID:
