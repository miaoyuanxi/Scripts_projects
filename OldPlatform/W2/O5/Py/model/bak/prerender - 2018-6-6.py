...
def ConductMel():
    ...
    print "the glmCrowd load is %s " % glmCrowd_load
...
if user_id not in [1813119,962276,1820648,1849290]:  
    ConductMel()
    resetup()
    rd_path()
    get_image_namespace()
...
if user_id in [1855708,900045,1855110,1833038,1834849,1857988,1826800,1860992,1163411,1862577,1830380,1822281,1852326,1868563,1849290,963140,1862389,1865352,1864255,1870881,1879938,1833958,1895687,1869176,1814856,1894815,1866675,1857429,1820648]:
    print start
    print int(start)
    if start:
        cmds.currentTime(int(start),edit=True)
...
if user_id in [1814856]:
    ...
    for i in pm.ls(type="aiOptions"):
        ...
        if i.hasAttr("textureMaxMemoryMB"):
            i.textureMaxMemoryMB.set(2048)
            print "textureMaxMemoryMB.set(2048)"
