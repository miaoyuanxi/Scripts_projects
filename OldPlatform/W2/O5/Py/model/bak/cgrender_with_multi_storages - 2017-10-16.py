...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if self["common"]["userId"] in [119768,963250,1833038,1844854,1017637,1843698,1832764,1833080,1833047,1833042,1847323,1300061,1814856,1818411,1840793,1848725,1815272,963260,1852550,1843088,1852657,1016752,830123,1818014,1805679,1861025,1840038,1844068,1843589,1855835,1814431,1859072,1859047,1813119,1860909,962276,1860293,1849290,1861648,1841452,1807271,1861569,1863971,1863854,1855110,1834849,1862390,1857988,1860992,1163411,1845209,1861572]:
        ...
        if "RenderMan_for_Maya" in self["plugins"]["plugins"]:
            ...
            gpu_n="0,1"
            cmd += " -gpu {%s}" % (gpu_n)
        elif self["common"]["userId"] in [1844854,1860501,962413,962640,1814964,963287, 963492,1861648]:
