...
class MayaRender(MayaClass):
    ...
    def render(self):
        ...
        if self["common"]["userId"] in [1017637,1843698,1832764,1833080,1833047,1833042,1847323,1300061,1814856]:
        ...
        if "RenderMan_for_Maya" in self["plugins"]["plugins"]:
            ...
            if self["common"]["userId"] in [961743,1844765,964311,1819610,1814856]:
