...
class MayaRender(MayaClass):
    ...
    #                    cmd += " -im \"%s\"" % image_name
        ...
        print self["mappings"]
        if self["common"]["userId"] in [1017637,1844577,1820999,1857698,1853469,1843589,1861628,1805997,1862416]:
        ...
        if self["common"]["userId"] in [1850239,963287, 963492, 963250, 964462,965366]:
            cmd += " -r arnold -ai:lve 1"
        if self["common"]["userId"] in [1853469,1849549,1824747,1859782,1857702]:
