...
if user_id in [1857988]:
    rd_path()
if user_id in [962276,1855110,1833038,1834849,1857988,1826800,1860992,1163411,1862577,1830380,1822281,1852326,1868563,1849290]:
    for i in pm.ls(type="aiOptions"):
        # print "defaultArnoldRenderOptions.abortOnError 0"
        # i.abortOnError.set(1)
        if i.hasAttr("log_verbosity"):
